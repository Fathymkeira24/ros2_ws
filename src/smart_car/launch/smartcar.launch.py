...
def generate_launch_description():
    ...
    xacro_file = FindPackageShare('smart_car').find('smart_car') + '/urdf/smartcar.urdf.xacro'

 # Locate the path to your URDF/Xacro file
    world_file = FindPackageShare('smart_car').find('smart_car') + '/world/smartcar.world'
